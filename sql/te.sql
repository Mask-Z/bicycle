...
INSERT INTO `flower` (`id`, `amount`, `name`, `price`, `foregift`, `cart_id`) VALUES
	(1, 99, '飞鸽', 10.1, 100.1, NULL),
	(2, 99, '凤凰', 20, 200, NULL),
	(3, 96, '机器猫', 30, 300, NULL),
	(5, 1, '白龙马', 100, 1300, NULL),
	(7, 2, '企鹅', 199, 1990, NULL),
	(8, 12, '郁金香', 1, 10, NULL);
...
-- 正在导出表  bicycle.indent 的数据：~2 rows (大约)
DELETE FROM `indent`;
...
INSERT INTO `indent` (`id`, `address`, `deal_details`, `pay_date`, `pay_state`, `pay_style`, `post_style`, `state`, `total_money`, `user_id`, `flower_id`) VALUES
	(1, NULL, '机器猫*1', '2016-12-27 10:47:19', NULL, 1, NULL, 2, 30, 1, NULL),
	(2, NULL, '机器猫*2,飞鸽*1', '2016-12-27 11:16:25', NULL, 1, NULL, 2, 70, 1, NULL),
	(3, NULL, '凤凰*1', '2016-12-28 14:11:29', NULL, 2, NULL, 1, 20, 1, NULL),
	(4, NULL, '凤凰*1', '2016-12-28 14:19:54', NULL, 2, NULL, 1, 20, 1, NULL),
	(5, NULL, '凤凰*1', '2016-12-28 14:32:31', NULL, 1, NULL, 1, 20, 1, NULL);
...
-- 正在导出表  bicycle.user 的数据：~1 rows (大约)
DELETE FROM `user`;
/*!40000 ALTER TABLE `user` DISABLE KEYS */;
INSERT INTO `user` (`id`, `account`, `city`, `gender`, `name`, `number`, `password`, `realname`, `role`) VALUES
	(1, NULL, '海角天涯', NULL, 'test', '15851932796', 'test', '测试用户', 0),
	(2, NULL, '天涯海角', NULL, 'admin', '15851932796', 'admin', '管理员', 1);
